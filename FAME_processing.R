...
# 2.3.1 inter-regional disparity ----------------------------------------------------------------
...
# 2.3.2 intra-regional disparity ---------------------------------------------------------------
...
tm_shape(localmap) +
  ...
  tm_compass(type = "4star", 
             ...
             position = c(0.5, 0.05))  
# 相关性
ggplot(localmap, aes(gini_turnover2001,ginichange))+
  geom_point()+
  geom_smooth(method = "lm", se = FALSE)+
  xlab("GINI index -- 2001")+
  ylab("GINI index change")+
  theme_bw()

# WILL local authority(map) ----------------------------------------------------
tm_shape(localmap) +
  tm_polygons("willchange", palette="RdYlBu", midpoint = 0,
              breaks = c(-1,-0.5,0,0.5,1,1.5,2,7),
              title="Williamson index chage(2001-2018)", id="name",legend.hist = TRUE) +
  tm_borders(col = "white",alpha = 0.5)+
  tm_shape(regionmap)+tm_borders(col = "black",lwd = 2)+
  tm_fill(alpha = 0)+
...
# 01 and 18
tm_shape(localmap) +
  tm_polygons("williamson_percapita2001", palette="RdYlBu", midpoint = 0,
              breaks = seq(0,2.5,0.5),
              title="Williamson index 2001", id="name",legend.hist = TRUE) +
  tm_borders(col = "white",alpha = 0.5)+
  tm_shape(regionmap)+tm_borders(col = "black",lwd = 2)+
  tm_fill(alpha = 0)+
  tm_text("rgn18nm",size=1,col="black",just = "top") +
...
tm_shape(localmap) +
  tm_polygons("williamson_percapita2018", palette="RdYlBu", midpoint = 0,
              breaks = c(seq(0,2,0.5),7),
              title="Williamson index 2018", id="name",legend.hist = TRUE) +
  tm_borders(col = "white",alpha = 0.5)+
  tm_shape(regionmap)+tm_borders(col = "black",lwd = 2)+
  tm_fill(alpha = 0)+
  tm_text("rgn18nm",size=1,col="black",just = "top") +
...
# 相关性
ggplot(localmap, aes(williamson_percapita2001,willchange))+
  geom_point()+
  geom_smooth(method = "lm", se = FALSE)+
  xlab("GINI index -- 2001")+
  ylab("GINI index change")+
...
# B. Regional disparities over time  --------------------------------------
data (G.counties.gdp)
...
# 2.2 import pacakage "diverse" and "pheatmap" ---------------------------
